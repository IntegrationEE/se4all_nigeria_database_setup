...
Insert data into boundary_adm1 table
...
INSERT INTO se4all.boundary_adm1 (adm1_pcode, adm1_en, geom)
SELECT adm1_pcode, 
    adm1_en,
    ST_Transform(geom,3857)
FROM import.boundary_adm1_import;

-- database log (project,version,io,schema_name,table_name,script_name,comment)
SELECT database_log('se4all','v0','setup','se4all','boundary_adm1','boundary_adm1_processing.sql','Add data');
