...
Insert data into osm_building table
...
INSERT INTO se4all.osm_building (osm_building_id, osm_id, building, area_m2, tags, geom)
SELECT gid, 
    osm_id,
    building,
    way_area,
...
FROM import.osm_nga_polygon
WHERE building IS NOT NULL;

-- database log (project,version,io,schema_name,table_name,script_name,comment)
SELECT database_log('se4all','v0','setup','se4all','osm_building','osm_building_processing.sql','Add data');
