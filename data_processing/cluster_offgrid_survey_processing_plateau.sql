...
-- insert data from import for SURVEY Plateau 1
...
FROM import.offgrid_survey_plateau_wo_1;
...
-- insert data from import for SURVEY Plateau 2
INSERT INTO se4all.cluster_offgrid_survey (
    cluster_offgrid_id, 
    wo_number, 
    settlement_wo_id,
...
SELECT 
   ...
   -- mg_present::BOOLEAN, -- mini_grid_presence
   -- mg_status, -- mini_grid_status
   --mg_gen_type,-- mini_grid_primary_generation_type
    ST_Transform(geom,3857)
FROM import.offgrid_survey_plateau_wo_2;
...
--SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey','cluster_offgrid_survey_processing_plateau.sql','Insert data');
