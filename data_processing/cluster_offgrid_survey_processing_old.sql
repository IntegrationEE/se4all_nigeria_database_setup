...
WHERE wo_number = '0'; -- for the old surveys we assigned a "WO zero"

-- insert data from import for old data (7 sites, 3 in Nasarawa, 4 in Kano)
...
SELECT 
    ...
    cluster_id::INTEGER, -- settlement_wo_id
    ...
    CASE  -- grid_voltage
        ...
        WHEN(voltage_gr = 'LV & MV') THEN 'mv_and_lv'
    END,
...
FROM import.offgrid_survey_old;
...
-- SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey','cluster_offgrid_survey_processing_old.sql','Insert data');