...
WHERE state_name = 'FCT';

-- insert data from import for SURVEY FCT 1
...
FROM import.offgrid_survey_fct_wo_1;
...
--SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey','cluster_offgrid_survey_processing_fct.sql','Insert data');
