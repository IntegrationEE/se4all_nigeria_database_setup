...
-- insert data from import for survey_small_geneators Jigawa 1
...
SELECT 
    ...
    TO_DATE(today::varchar, 'DD-MM-YYYY'), -- survey_date
...
FROM import.offgrid_survey_small_generators_jigawa_wo_1
WHERE generator != 'no generator';

-- database log (project,version,io,schema_name,table_name,script_name,comment)
SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey_small_generators','cluster_offgrid_survey_processing_small_generators_jigawa_sql','Insert data');

-- insert data from import for survey_small_geneators Jigawa 2
INSERT INTO se4all.cluster_offgrid_survey_small_generators (
    cluster_offgrid_id,
    wo_number,
    settlement_wo_id,
...
SELECT 
    ...
    END,
    ST_Transform(geom,3857)
FROM import.offgrid_survey_small_generators_jigawa_wo_2
WHERE generator != 'no generator';

-- database log (project,version,io,schema_name,table_name,script_name,comment)
SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey_small_generators','cluster_offgrid_survey_processing_small_generators_jigawa.sql','Insert data');

-- insert data from import for survey_small_geneators Jigawa 3
INSERT INTO se4all.cluster_offgrid_survey_small_generators (
    cluster_offgrid_id,
    wo_number,
    settlement_wo_id,
...
SELECT 
    ...
    END,
    ST_Transform(geom,3857)
FROM import.offgrid_survey_small_generators_jigawa_wo_3
WHERE generator != 'no generator';

-- insert data from import for survey_small_geneators Jigawa 4
INSERT INTO se4all.cluster_offgrid_survey_small_generators (
    cluster_offgrid_id,
    wo_number,
    settlement_wo_id,
...
SELECT 
    ...
    END,
    ST_Transform(geom,3857)
FROM import.offgrid_survey_small_generators_jigawa_wo_4
WHERE generator != 'no generator';
