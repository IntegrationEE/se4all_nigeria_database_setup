...
WHERE state_name = 'Abia';

-- insert data from import for SURVEY Abia
...
FROM import.offgrid_survey_abia_wo_1;
...
--SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey','cluster_offgrid_survey_processing_abia.sql','Insert data');
