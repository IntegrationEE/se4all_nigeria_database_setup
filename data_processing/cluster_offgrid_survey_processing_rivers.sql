...
SELECT 
    ...
    electricit::BOOLEAN, -- mini_grid_presence
    -- colum_name, -- mini_grid_status
    --mg_gen_typ, -- mini_grid_primary_generation_type
    ST_Transform(geom,3857)
FROM import.offgrid_survey_rivers_wo_1;
...
-- SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey','cluster_offgrid_survey_processing_rivers.sql','Insert data');
