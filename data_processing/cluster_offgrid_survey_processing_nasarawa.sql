...
WHERE state_name = 'Nasarawa' AND wo_number != 0;

-- insert data from import for SURVEY Nasarawa 1
...
SELECT 
   ...
   -- crop_cul11::BOOLEAN, -- crop_cultivated_cashew
    ...
    LOWER(household), -- households_with_genset_percentage 
    ...
    LOWER(specify_ot), -- name_productive_use_other
    ...
    LOWER(specify__1), -- name_commercial_other
    ...
    LOWER(specify__2), -- name_craft_other
...
FROM import.offgrid_survey_nasarawa_wo_1;
...
--SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey','cluster_offgrid_survey_processing_nasarawa.sql','Insert data');


-- insert data from import for SURVEY Nasarawa 2
INSERT INTO se4all.cluster_offgrid_survey (
    cluster_offgrid_id, 
    wo_number, 
    settlement_wo_id,
...
SELECT 
   ...
   -- mg_status, -- mini_grid_status
    --mg_gen_typ, -- mini_grid_primary_generation_type
    ST_Transform(geom,3857)
FROM import.offgrid_survey_nasarawa_wo_2;
