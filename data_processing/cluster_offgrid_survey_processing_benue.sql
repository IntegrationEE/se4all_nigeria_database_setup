...
-- insert data from import for SURVEY Benue 1
...
FROM import.offgrid_survey_benue_wo_1;
...
-- insert data from import for SURVEY Benue 2
INSERT INTO se4all.cluster_offgrid_survey (
    cluster_offgrid_id, 
    wo_number, 
    settlement_wo_id,
...
SELECT 
   ...
   -- mg_status, -- mini_grid_status
    --mg_gen_typ, -- mini_grid_primary_generation_type
    ST_Transform(geom,3857)
FROM import.offgrid_survey_benue_wo_2;
...
-- insert data from import for SURVEY Benue 3
INSERT INTO se4all.cluster_offgrid_survey (
    cluster_offgrid_id, 
    wo_number, 
    settlement_wo_id,
...
SELECT 
   ...
   -- mg_status, -- mini_grid_status
    --mg_gen_typ, -- mini_grid_primary_generation_type
    ST_Transform(geom,3857)
FROM import.offgrid_survey_benue_wo_3;
...
--SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey','cluster_offgrid_survey_processing_benue.sql','Insert data');