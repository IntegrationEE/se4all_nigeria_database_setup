...
WHERE state_name = 'Kogi';

-- insert data from import for SURVEY Kogi 1
...
SELECT 
    ...
    crop_cul12::BOOLEAN, -- crop_cultivated_cashew
    crop_cul13::BOOLEAN, --crop_cultivated_yam
    crop_cul14::BOOLEAN, --crop_cultivated_cocoa
...
FROM import.offgrid_survey_kogi_wo_1;
...
--SELECT database_log('se4all','v0','setup','se4all','cluster_offgrid_survey','cluster_offgrid_survey_processing_kogi.sql','Insert data');


-- insert data from import for SURVEY Kogi 2
INSERT INTO se4all.cluster_offgrid_survey (
    cluster_offgrid_id, 
    wo_number, 
    settlement_wo_id,
...
SELECT 
   ...
   -- mg_status, -- mini_grid_status
    --mg_gen_typ, -- mini_grid_primary_generation_type
    ST_Transform(geom,3857)
FROM import.offgrid_survey_kogi_wo_2;
